...
// 'when requested with If-Modified-Since'
  // 'when modified since the date'
    test('should be stale', () => {
      const reqHeaders = new Headers({ 'If-Modified-Since': 'Sat, 01 Jan 2000 00:00:00 GMT' });
      const resHeaders = new Headers({ 'Last-Modified': 'Sat, 01 Jan 2000 01:00:00 GMT' });
      assert(!fresh(reqHeaders, resHeaders));
    });

  // 'when unmodified since the date'
    test('should be fresh', () => {
      const reqHeaders = new Headers({ 'If-Modified-Since': 'Sat, 01 Jan 2000 01:00:00 GMT' });
      const resHeaders = new Headers({ 'Last-Modified': 'Sat, 01 Jan 2000 00:00:00 GMT' });
      assert(fresh(reqHeaders, resHeaders));
    });
...
// 'when requested with If-Modified-Since and If-None-Match'
  // 'when both match'
    test('should be fresh', () => {
      const reqHeaders = new Headers({ 'If-None-Match': '"foo"', 'If-Modified-Since': 'Sat, 01 Jan 2000 01:00:00 GMT' });
      const resHeaders = new Headers({ 'ETag': '"foo"', 'Last-Modified': 'Sat, 01 Jan 2000 00:00:00 GMT' });
      assert(fresh(reqHeaders, resHeaders));
    });

  // 'when only ETag matches'
    test('should be stale', () => {
      const reqHeaders = new Headers({ 'If-None-Match': '"foo"', 'If-Modified-Since': 'Sat, 01 Jan 2000 00:00:00 GMT' });
      const resHeaders = new Headers({ 'ETag': '"foo"', 'Last-Modified': 'Sat, 01 Jan 2000 01:00:00 GMT' });
      assert(!fresh(reqHeaders, resHeaders));
    });
  ...
  // 'when only Last-Modified matches'
    test('should be stale', () => {
      const reqHeaders = new Headers({ 'If-None-Match': '"foo"', 'If-Modified-Since': 'Sat, 01 Jan 2000 01:00:00 GMT' });
      const resHeaders = new Headers({ 'ETag': '"bar"', 'Last-Modified': 'Sat, 01 Jan 2000 00:00:00 GMT' });
      assert(!fresh(reqHeaders, resHeaders));
    });
  ...
  // 'when none match'
    test('should be stale', () => {
      const reqHeaders = new Headers({ 'If-None-Match': '"foo"', 'If-Modified-Since': 'Sat, 01 Jan 2000 00:00:00 GMT' });
      const resHeaders = new Headers({ 'ETag': '"bar"', 'Last-Modified': 'Sat, 01 Jan 2000 01:00:00 GMT' });
      assert(!fresh(reqHeaders, resHeaders));
    });
...
// 'when requested with Cache-Control: no-cache'
  ...
  //'when ETags match'
  test('should be stale', () => {
    const reqHeaders = new Headers({ 'Cache-Control': ' no-cache', 'If-None-Match': '"foo"' });
    const resHeaders = new Headers({ 'ETag': '"foo"' });
    assert(!fresh(reqHeaders, resHeaders));
  });
  ...
  //'when unmodified since the date', () => {
  test('should be stale', () => {
    const reqHeaders = new Headers({ 'Cache-Control': ' no-cache', 'If-Modified-Since': 'Sat, 01 Jan 2000 01:00:00 GMT' });
    const resHeaders = new Headers({ 'Last-Modified': 'Sat, 01 Jan 2000 00:00:00 GMT' });
    assert(!fresh(reqHeaders, resHeaders));
  });
